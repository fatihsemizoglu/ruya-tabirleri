...
// Mock search data for placeholder
const mockSearchData: SearchStat[] = [
  { query: 'su görmek', count: 245, last_searched: new Date().toISOString() },
  { query: 'ölmüş anneyi görmek', count: 189, last_searched: subDays(new Date(), 1).toISOString() },
  { query: 'para bulmak', count: 156, last_searched: subDays(new Date(), 2).toISOString() },
  { query: 'düğün görmek', count: 134, last_searched: new Date().toISOString() },
  { query: 'bebek görmek', count: 123, last_searched: subDays(new Date(), 1).toISOString() },
  { query: 'uçmak', count: 98, last_searched: subDays(new Date(), 3).toISOString() },
  { query: 'kaybetmek', count: 87, last_searched: subDays(new Date(), 2).toISOString() },
  { query: 'köpek görmek', count: 76, last_searched: new Date().toISOString() },
  { query: 'araba sürmek', count: 65, last_searched: subDays(new Date(), 4).toISOString() },
  { query: 'yılan görmek', count: 54, last_searched: subDays(new Date(), 1).toISOString() },
  { query: 'ev görmek', count: 43, last_searched: subDays(new Date(), 5).toISOString() },
  { query: 'ölmüş baba', count: 38, last_searched: subDays(new Date(), 2).toISOString() },
  { query: 'kılıç görmek', count: 32, last_searched: subDays(new Date(), 6).toISOString() },
  { query: 'orman', count: 28, last_searched: subDays(new Date(), 3).toISOString() },
  { query: 'deniz', count: 25, last_searched: new Date().toISOString() },
];
...
export function SearchAnalytics() {
  ...
  const { data: stats, isLoading: isLoadingStats } = useQuery({
    ...
    queryFn: async () => {
      ...
      return {
        totalSearches: totalSearches || mockSearchData.reduce((sum, s) => sum + s.count, 0),
        uniqueQueries: uniqueQueries || mockSearchData.length,
        avgPerDay: Math.round((totalSearches || mockSearchData.reduce((sum, s) => sum + s.count, 0)) / days),
      };
    },
  });

  // Clear old logs - mock function since API doesn't support this
