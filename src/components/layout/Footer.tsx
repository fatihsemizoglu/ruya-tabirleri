        ...
        <div className="container py-12 md:py-20">
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-12 lg:gap-10">
            ...
            <div className="lg:col-span-5">
              ...
              <h3 className="text-2xl md:text-3xl font-bold text-white leading-tight mb-3 text-balance">
                Rüyalarınızın{' '}
              ...
              <div className="flex flex-col gap-2.5 xs:flex-row xs:flex-wrap">
                ...
                {settings.contactAddress && (
                  <span className="inline-flex max-w-full items-center gap-2 rounded-full bg-white/5 border border-white/10 px-3.5 py-2 text-sm">
            ...
            {/* Link columns */}
            <div className="lg:col-span-7 grid grid-cols-1 gap-8 xs:grid-cols-2 sm:grid-cols-3 sm:gap-10">
              <div>
          ...
          {/* Socials + bottom */}
          <div className="mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
