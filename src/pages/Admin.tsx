...
const StatisticsDashboard = lazy(() => import('@/components/admin/StatisticsDashboard'));
...
const AdvancedDashboard = lazy(() => import('@/components/admin/AdvancedDashboard'));
...
const BulkSEOGenerator = lazy(() => import('@/components/admin/BulkSEOGenerator'));
